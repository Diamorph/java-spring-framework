package com.diamorph.multipledatabases.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.diamorph.multipledatabases.product"}
)
...
//        productJpaProperties.put("hibernate.ddl-auto", "update"); // can do it also on the application properties (application level)
